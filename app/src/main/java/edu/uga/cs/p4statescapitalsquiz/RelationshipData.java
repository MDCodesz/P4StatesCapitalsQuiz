...
public class RelationshipData {
    ...
    private static final String[] allColumns = {
            StateCapitalsQuizDBHelper.RELATIONSHIP_COLUMN_ID,
            StateCapitalsQuizDBHelper.RELATIONSHIP_COLUMN_QUESTION_ID,
            StateCapitalsQuizDBHelper.RELATIONSHIP_COLUMN_QUIZ_ID,
            StateCapitalsQuizDBHelper.RELATIONSHIP_COLUMN_USER_ANSWER
    };
    ...
    public List<Relationship> retrieveAllRelationships() {
        ...
        try {
            ...
            cursor = db.query( StateCapitalsQuizDBHelper.TABLE_RELATIONSHIP, allColumns,
            ...
            if( cursor != null && cursor.getCount() > 0 ) {
                ...
                while( cursor.moveToNext() ) {
                    ...
                    if( cursor.getColumnCount() >= 5) {
                        ...
                        columnIndex = cursor.getColumnIndex( StateCapitalsQuizDBHelper.RELATIONSHIP_COLUMN_ID );
                        long id = cursor.getLong( columnIndex );
                        columnIndex = cursor.getColumnIndex( StateCapitalsQuizDBHelper.RELATIONSHIP_COLUMN_QUESTION_ID );
                        long questionId = cursor.getLong( columnIndex );
                        columnIndex = cursor.getColumnIndex( StateCapitalsQuizDBHelper.RELATIONSHIP_COLUMN_QUIZ_ID );
                        long quizId = cursor.getLong( columnIndex );
                        columnIndex = cursor.getColumnIndex( StateCapitalsQuizDBHelper.RELATIONSHIP_COLUMN_USER_ANSWER );
    ...
    public Relationship storeRelationship( Relationship relationship ) {
        ...
        values.put( StateCapitalsQuizDBHelper.RELATIONSHIP_COLUMN_QUESTION_ID, relationship.getQuestionId());
        values.put( StateCapitalsQuizDBHelper.RELATIONSHIP_COLUMN_QUIZ_ID, relationship.getQuizId() );
        values.put( StateCapitalsQuizDBHelper.RELATIONSHIP_COLUMN_USER_ANSWER, relationship.getUserAnswer() );

        // Insert the new row into the database table;
        // The id (primary key) is automatically generated by the database system
        // and returned as from the insert method call.
        long id = db.insert( StateCapitalsQuizDBHelper.TABLE_RELATIONSHIP, null, values );
